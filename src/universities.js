...
export const UNIVERSITIES = [
  ...
  { id: 'unt',      name: 'UNT',      full: 'Universidad Nacional de Tucumán',                                     province: 'Tucumán',         type: 'nacional',  color: '#1A5C38', logo: '/logos/unt.webp'          },
  ...
  { id: 'unne',     name: 'UNNE',     full: 'Universidad Nacional del Nordeste',                                   province: 'Corrientes',      type: 'nacional',  color: '#1B6CA8', logo: '/logos/unne_new.webp'     },
