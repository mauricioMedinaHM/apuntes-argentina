...
export const UNIVERSITIES = [
  ...
  { id: 'unl',      name: 'UNL',      full: 'Universidad Nacional del Litoral',                                    province: 'Santa Fe',        type: 'nacional',  color: '#005B9A', logo: '/logos/unl.webp'          },
  ...
  { id: 'uns',      name: 'UNS',      full: 'Universidad Nacional del Sur',                                        province: 'Buenos Aires',    type: 'nacional',  color: '#1B4B8A', logo: '/logos/uns.webp'          },
  ...
  { id: 'unsj',     name: 'UNSJ',     full: 'Universidad Nacional de San Juan',                                    province: 'San Juan',        type: 'nacional',  color: '#5C3317', logo: '/logos/unsj_dark.webp'  },
  { id: 'unsl',     name: 'UNSL',     full: 'Universidad Nacional de San Luis',                                    province: 'San Luis',        type: 'nacional',  color: '#4A6B8A', logo: '/logos/unsl.webp'         },
  { id: 'unse',     name: 'UNSE',     full: 'Universidad Nacional de Santiago del Estero',                         province: 'Santiago del Estero', type: 'nacional', color: '#7B4F2E', logo: '/logos/unse.webp'    },
  { id: 'unco',     name: 'UNCo',     full: 'Universidad Nacional del Comahue',                                    province: 'Neuquén',         type: 'nacional',  color: '#2E6B5E', logo: '/logos/unco_dark.webp'         },
  ...
  { id: 'unlu',     name: 'UNLu',     full: 'Universidad Nacional de Luján',                                       province: 'Buenos Aires',    type: 'nacional',  color: '#1D5C7B', logo: '/logos/unlu.webp'         },
  { id: 'unam_m',   name: 'UNaM',     full: 'Universidad Nacional de Misiones',                                    province: 'Misiones',        type: 'nacional',  color: '#4B7A3B', logo: '/logos/unam_dark.webp'         },
  { id: 'uner',     name: 'UNER',     full: 'Universidad Nacional de Entre Ríos',                                  province: 'Entre Ríos',      type: 'nacional',  color: '#2D6A6A', logo: '/logos/uner.webp'         },
  { id: 'unca',     name: 'UNCA',     full: 'Universidad Nacional de Catamarca',                                   province: 'Catamarca',       type: 'nacional',  color: '#6B3B2E', logo: '/logos/unca_dark.webp'         },
  { id: 'unju',     name: 'UNJu',     full: 'Universidad Nacional de Jujuy',                                       province: 'Jujuy',           type: 'nacional',  color: '#4A7A3E', logo: '/logos/unju.webp'         },
  ...
  { id: 'unicen',   name: 'UNICEN',   full: 'Universidad Nacional del Centro de la Prov. de Buenos Aires',        province: 'Buenos Aires',    type: 'nacional',  color: '#1B4B6B', logo: '/logos/unicen_dark.webp'       },
  { id: 'unf',      name: 'UNF',      full: 'Universidad Nacional de Formosa',                                     province: 'Formosa',         type: 'nacional',  color: '#3B6B3B', logo: '/logos/unf.webp'          },
  { id: 'unsam',    name: 'UNSAM',    full: 'Universidad Nacional de General San Martín',                          province: 'Buenos Aires',    type: 'nacional',  color: '#1A3F6B', logo: '/logos/unsam.webp'        },
  ...
  { id: 'unq',      name: 'UNQ',      full: 'Universidad Nacional de Quilmes',                                     province: 'Buenos Aires',    type: 'nacional',  color: '#23355C', logo: '/logos/unq_dark.webp'          },
  ...
  { id: 'unlpam',   name: 'UNLPam',   full: 'Universidad Nacional de La Pampa',                                    province: 'La Pampa',        type: 'nacional',  color: '#5B3D1A', logo: '/logos/unlpam.webp'       },
  ...
  { id: 'unlar',    name: 'UNLaR',    full: 'Universidad Nacional de La Rioja',                                    province: 'La Rioja',        type: 'nacional',  color: '#7B2D1A', logo: '/logos/unlar.webp'        },
  { id: 'unvm',     name: 'UNVM',     full: 'Universidad Nacional de Villa María',                                  province: 'Córdoba',         type: 'nacional',  color: '#1A5B4B', logo: '/logos/unvm.webp'         },
  ...
  { id: 'unnoba',   name: 'UNNOBA',   full: 'Universidad Nacional del Noroeste de la Prov. de Buenos Aires',      province: 'Buenos Aires',    type: 'nacional',  color: '#2B5B7B', logo: '/logos/unnoba.webp'       },
  ...
  { id: 'undav',    name: 'UNDAV',    full: 'Universidad Nacional de Avellaneda',                                  province: 'Buenos Aires',    type: 'nacional',  color: '#2B4B8B', logo: '/logos/undav.webp'        },
  { id: 'unm',      name: 'UNM',      full: 'Universidad Nacional de Moreno',                                      province: 'Buenos Aires',    type: 'nacional',  color: '#4B2D7B', logo: '/logos/unm.webp'          },
  { id: 'uno',      name: 'UNO',      full: 'Universidad Nacional del Oeste',                                      province: 'Buenos Aires',    type: 'nacional',  color: '#1B5B4B', logo: '/logos/uno.webp'                       },
  { id: 'untdf',    name: 'UNTDF',    full: 'Univ. Nacional de Tierra del Fuego, Antártida e Islas del Atlántico Sur', province: 'Tierra del Fuego', type: 'nacional', color: '#1A3A5B', logo: '/logos/untdf_dark.webp'  },
  ...
  // ════════════════════════════════════════════
  { id: 'utn_frba',  name: 'UTN-BA',        full: 'UTN Facultad Regional Buenos Aires',        province: 'CABA',            type: 'utn', color: '#C8102E', logo: '/logos/utn_frba.webp'  },
  { id: 'utn_cor',   name: 'UTN-Córdoba',   full: 'UTN Facultad Regional Córdoba',             province: 'Córdoba',         type: 'utn', color: '#C8102E', logo: '/logos/utn_cor.webp'   },
  { id: 'utn_ros',   name: 'UTN-Rosario',   full: 'UTN Facultad Regional Rosario',             province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_mdp',   name: 'UTN-MdP',       full: 'UTN Facultad Regional Mar del Plata',       province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_mza',   name: 'UTN-Mendoza',   full: 'UTN Facultad Regional Mendoza',             province: 'Mendoza',         type: 'utn', color: '#C8102E', logo: '/logos/utn_mza.webp'   },
  { id: 'utn_tuc',   name: 'UTN-Tucumán',   full: 'UTN Facultad Regional Tucumán',             province: 'Tucumán',         type: 'utn', color: '#C8102E', logo: '/logos/utn_tuc.webp'   },
  { id: 'utn_bb',    name: 'UTN-Bahía',     full: 'UTN Facultad Regional Bahía Blanca',        province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_lp',    name: 'UTN-La Plata',  full: 'UTN Facultad Regional La Plata',            province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_lp.svg'    },
  { id: 'utn_stafe', name: 'UTN-Santa Fe',  full: 'UTN Facultad Regional Santa Fe',            province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_stafe.webp' },
  { id: 'utn_res',   name: 'UTN-Resist.',   full: 'UTN Facultad Regional Resistencia',         province: 'Chaco',           type: 'utn', color: '#C8102E', logo: '/logos/utn_res.webp'   },
  { id: 'utn_par',   name: 'UTN-Paraná',    full: 'UTN Facultad Regional Paraná',              province: 'Entre Ríos',      type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_ave',   name: 'UTN-Avell.',    full: 'UTN Facultad Regional Avellaneda',          province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_hae',   name: 'UTN-Haedo',     full: 'UTN Facultad Regional Haedo',               province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_hae.webp'   },
  { id: 'utn_sn',    name: 'UTN-S.Nicolás', full: 'UTN Facultad Regional San Nicolás',         province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_fcu',   name: 'UTN-CdU',       full: 'UTN Facultad Regional Concepción del Urug.', province: 'Entre Ríos',    type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_con',   name: 'UTN-Concordia', full: 'UTN Facultad Regional Concordia',           province: 'Entre Ríos',      type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_del',   name: 'UTN-Delta',     full: 'UTN Facultad Regional Delta',               province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_gp',    name: 'UTN-G.Pacheco', full: 'UTN Facultad Regional General Pacheco',     province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_lr',    name: 'UTN-La Rioja',  full: 'UTN Facultad Regional La Rioja',            province: 'La Rioja',        type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_nqn',   name: 'UTN-Neuquén',   full: 'UTN Facultad Regional Neuquén',             province: 'Neuquén',         type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_raf',   name: 'UTN-Rafaela',   full: 'UTN Facultad Regional Rafaela',             province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_rec',   name: 'UTN-Reconq.',   full: 'UTN Facultad Regional Reconquista',         province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_sfc',   name: 'UTN-S.Fco.',    full: 'UTN Facultad Regional San Francisco',       province: 'Córdoba',         type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_sr',    name: 'UTN-S.Rafael',  full: 'UTN Facultad Regional San Rafael',          province: 'Mendoza',         type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_sc',    name: 'UTN-S.Cruz',    full: 'UTN Facultad Regional Santa Cruz',          province: 'Santa Cruz',      type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_tdf',   name: 'UTN-TDF',       full: 'UTN Facultad Regional Tierra del Fuego',    province: 'Tierra del Fuego',type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  { id: 'utn_tl',    name: 'UTN-Trenque',   full: 'UTN Facultad Regional Trenque Lauquen',     province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_vt',    name: 'UTN-V.Tuerto',  full: 'UTN Facultad Regional Venado Tuerto',       province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_vm',    name: 'UTN-V.María',   full: 'UTN Facultad Regional Villa María',         province: 'Córdoba',         type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'    },
  { id: 'utn_chu',   name: 'UTN-Chubut',    full: 'UTN Facultad Regional Chubut',              province: 'Chubut',          type: 'utn', color: '#C8102E', logo: '/logos/utn_regional_base.webp'   },
  ...
  { id: 'ulp',      name: 'ULP',      full: 'Universidad de La Punta',                                             province: 'San Luis',        type: 'provincial', color: '#3B6B2B', logo: '/logos/ulp_dark.webp'                      },
  { id: 'upro',     name: 'UPrO',     full: 'Universidad Provincial de Oficios Eva Perón',                        province: 'San Luis',        type: 'provincial', color: '#4B2B5B', logo: '/logos/upro_dark.webp'                      },
  { id: 'upe',      name: 'UPE',      full: 'Universidad Provincial de Ezeiza',                                    province: 'Buenos Aires',    type: 'provincial', color: '#1B4B6B', logo: '/logos/upe_dark.webp'                      },
  { id: 'upso',     name: 'UPSO',     full: 'Universidad Provincial del Sudoeste',                                 province: 'Buenos Aires',    type: 'provincial', color: '#1A4B5B', logo: '/logos/upso_shield.webp'                      },
  { id: 'upateco',  name: 'UPATecO',  full: 'Univ. Provincial de Administración, Tecnología y Oficios',           province: 'Salta',           type: 'provincial', color: '#6B2B1A', logo: '/logos/upateco_dark.webp'                      },
  ...
  { id: 'uai',      name: 'UAI',      full: 'Universidad Abierta Interamericana',                                  province: 'CABA',            type: 'privada',   color: '#8B1A1A', logo: '/logos/uai.webp'          },
  { id: 'uap',      name: 'UAP',      full: 'Universidad Adventista del Plata',                                    province: 'Entre Ríos',      type: 'privada',   color: '#1A5B3B', logo: '/logos/uap.webp'                       },
  { id: 'uade',     name: 'UADE',     full: 'Universidad Argentina de la Empresa',                                 province: 'CABA',            type: 'privada',   color: '#1A1A6B', logo: '/logos/uade.webp'         },
  ...
  { id: 'ua',       name: 'UA',       full: 'Universidad Austral',                                                 province: 'CABA',            type: 'privada',   color: '#1A2B4B', logo: '/logos/ua.webp'           },
  { id: 'ubp',      name: 'UBP',      full: 'Universidad Blas Pascal',                                             province: 'Córdoba',         type: 'privada',   color: '#2B5FA3', logo: '/logos/ubp.webp'                       },
  { id: 'ucaece',   name: 'UCAECE',   full: 'Universidad CAECE',                                                   province: 'CABA',            type: 'privada',   color: '#3B1A5B', logo: '/logos/ucaece_dark.webp'                       },
  { id: 'uca',      name: 'UCA',      full: 'Pontificia Universidad Católica Argentina',                           province: 'CABA',            type: 'privada',   color: '#7B1A1A', logo: '/logos/uca.webp'          },
  { id: 'ucc',      name: 'UCC',      full: 'Universidad Católica de Córdoba',                                     province: 'Córdoba',         type: 'privada',   color: '#7B2B1A', logo: '/logos/ucc_dark.webp'          },
  ...
  { id: 'ucasal',   name: 'UCASAL',   full: 'Universidad Católica de Salta',                                       province: 'Salta',           type: 'privada',   color: '#6B2B1A', logo: '/logos/ucasal.webp'       },
  ...
  { id: 'ub',       name: 'UB',       full: 'Universidad de Belgrano',                                             province: 'CABA',            type: 'privada',   color: '#1A3B7B', logo: '/logos/ub_dark.webp'           },
  { id: 'uces',     name: 'UCES',     full: 'Universidad de Ciencias Empresariales y Sociales',                   province: 'CABA',            type: 'privada',   color: '#2B4B6B', logo: '/logos/uces_dark.webp'         },
  { id: 'ucu',      name: 'UCU',      full: 'Universidad de Concepción del Uruguay',                               province: 'Entre Ríos',      type: 'privada',   color: '#1A5B4B', logo: '/logos/ucu_dark.webp'                       },
  ...
  { id: 'up',       name: 'UP',       full: 'Universidad de Palermo',                                              province: 'CABA',            type: 'privada',   color: '#1A1A8B', logo: '/logos/up.webp'           },
  ...
  { id: 'ucine',    name: 'UCINE',    full: 'Universidad del Cine',                                                province: 'CABA',            type: 'privada',   color: '#4B1A3B', logo: '/logos/ucine_dark.webp'                       },
  ...
  { id: 'unsta',    name: 'UNSTA',    full: 'Universidad del Norte Santo Tomás de Aquino',                         province: 'Tucumán',         type: 'privada',   color: '#5B2B1A', logo: '/logos/unsta_dark.webp'                       },
  { id: 'usal',     name: 'USAL',     full: 'Universidad del Salvador',                                            province: 'CABA',            type: 'privada',   color: '#1A3B5B', logo: '/logos/usal.webp'         },
  ...
  { id: 'ues21',    name: 'UES21',    full: 'Universidad Empresarial Siglo 21',                                    province: 'Córdoba',         type: 'privada',   color: '#1A1A4B', logo: '/logos/ues21.webp'        },
  { id: 'ufasta',   name: 'UFASTA',   full: 'Universidad FASTA',                                                   province: 'Buenos Aires',    type: 'privada',   color: '#1A4B5B', logo: '/logos/ufasta.webp'                       },
  { id: 'uf',       name: 'UF',       full: 'Universidad Favaloro',                                                province: 'CABA',            type: 'privada',   color: '#1A3B6B', logo: '/logos/uf.webp'           },
  { id: 'ugd',      name: 'UGD',      full: 'Universidad Gastón Dachary',                                          province: 'Misiones',        type: 'privada',   color: '#2B5B2B', logo: '/logos/ugd_dark.webp'                       },
  { id: 'ui',       name: 'ISALUD',   full: 'Universidad ISALUD',                                                  province: 'CABA',            type: 'privada',   color: '#1A5B4B', logo: '/logos/isalud_dark.webp'                       },
  { id: 'umaza',    name: 'UMAZA',    full: 'Universidad Juan Agustín Maza',                                       province: 'Mendoza',         type: 'privada',   color: '#4B3B1A', logo: '/logos/umaza.webp'                       },
  { id: 'umai',     name: 'UMAI',     full: 'Universidad Maimónides',                                              province: 'CABA',            type: 'privada',   color: '#2B1A4B', logo: '/logos/umai.webp'         },
  ...
  { id: 'utdt',     name: 'UTDT',     full: 'Universidad Torcuato Di Tella',                                       province: 'CABA',            type: 'privada',   color: '#1A2B5B', logo: '/logos/utdt.webp'         },
...
export const FACULTIES = {
  ...
  'UTN-Rosario':   ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Eléctrica', 'Ingeniería Mecánica', 'Ingeniería Industrial', 'Ingeniería Química'],
  'UTN-MdP':       ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Electrónica', 'Ingeniería Mecánica', 'Ingeniería Industrial', 'Ingeniería Textil'],
  'UTN-Mendoza':   ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Electrónica', 'Ingeniería Electromecánica', 'Ingeniería Industrial', 'Ingeniería Química'],
  'UTN-Tucumán':   ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Electrónica', 'Ingeniería Mecánica', 'Ingeniería Industrial', 'Ingeniería Química', 'Ingeniería en Construcciones'],
  'UTN-Bahía':     ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Eléctrica', 'Ingeniería Electromecánica', 'Ingeniería Industrial', 'Ingeniería Química'],
  'UTN-La Plata':  ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Electrónica', 'Ingeniería Mecánica', 'Ingeniería Industrial', 'Ingeniería Aeronáutica'],
  'UTN-Santa Fe':  ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Electrónica', 'Ingeniería Electromecánica', 'Ingeniería Industrial', 'Ingeniería Química'],
  'UTN-Resist.':   ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Electrónica', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-Paraná':    ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Eléctrica', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-Avell.':    ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-Haedo':     ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Industrial', 'Ingeniería Mecánica', 'Ingeniería Electromecánica'],
  'UTN-S.Nicolás': ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Industrial', 'Ingeniería Mecánica', 'Ingeniería Metalúrgica'],
  'UTN-CdU':       ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Electromecánica', 'Ingeniería Industrial'],
  'UTN-Concordia': ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Electromecánica', 'Ingeniería Industrial'],
  'UTN-Delta':     ['Ingeniería en Sistemas', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-G.Pacheco': ['Ingeniería en Sistemas', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-La Rioja':  ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Industrial'],
  'UTN-Neuquén':   ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-Rafaela':   ['Ingeniería en Sistemas', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-Reconq.':   ['Ingeniería en Sistemas', 'Ingeniería Industrial'],
  'UTN-S.Fco.':    ['Ingeniería en Sistemas', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-S.Rafael':  ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Industrial'],
  'UTN-S.Cruz':    ['Ingeniería en Sistemas', 'Ingeniería Industrial'],
  'UTN-TDF':       ['Ingeniería en Sistemas', 'Ingeniería Industrial'],
  'UTN-Trenque':   ['Ingeniería en Sistemas', 'Ingeniería Industrial'],
  'UTN-V.Tuerto':  ['Ingeniería en Sistemas', 'Ingeniería Industrial', 'Ingeniería Mecánica'],
  'UTN-V.María':   ['Ingeniería en Sistemas', 'Ingeniería Industrial', 'Ingeniería Civil'],
  'UTN-Chubut':    ['Ingeniería en Sistemas', 'Ingeniería Civil', 'Ingeniería Industrial'],
