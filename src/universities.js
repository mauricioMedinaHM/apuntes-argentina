...
export const UNIVERSITIES = [
  ...
  // ════════════════════════════════════════════
  { id: 'utn_frba',  name: 'UTN-BA',        full: 'UTN Facultad Regional Buenos Aires',        province: 'CABA',            type: 'utn', color: '#C8102E', logo: '/logos/utn_frba.svg'  },
  { id: 'utn_cor',   name: 'UTN-Córdoba',   full: 'UTN Facultad Regional Córdoba',             province: 'Córdoba',         type: 'utn', color: '#C8102E', logo: '/logos/utn_cor.svg'   },
  { id: 'utn_ros',   name: 'UTN-Rosario',   full: 'UTN Facultad Regional Rosario',             province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_ros.svg'   },
  { id: 'utn_mdp',   name: 'UTN-MdP',       full: 'UTN Facultad Regional Mar del Plata',       province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_mdp.svg'   },
  { id: 'utn_mza',   name: 'UTN-Mendoza',   full: 'UTN Facultad Regional Mendoza',             province: 'Mendoza',         type: 'utn', color: '#C8102E', logo: '/logos/utn_mza.svg'   },
  { id: 'utn_tuc',   name: 'UTN-Tucumán',   full: 'UTN Facultad Regional Tucumán',             province: 'Tucumán',         type: 'utn', color: '#C8102E', logo: '/logos/utn_tuc.svg'   },
  { id: 'utn_bb',    name: 'UTN-Bahía',     full: 'UTN Facultad Regional Bahía Blanca',        province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_bb.svg'    },
  ...
  { id: 'utn_stafe', name: 'UTN-Santa Fe',  full: 'UTN Facultad Regional Santa Fe',            province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_stafe.svg' },
  { id: 'utn_res',   name: 'UTN-Resist.',   full: 'UTN Facultad Regional Resistencia',         province: 'Chaco',           type: 'utn', color: '#C8102E', logo: '/logos/utn_res.svg'   },
  { id: 'utn_par',   name: 'UTN-Paraná',    full: 'UTN Facultad Regional Paraná',              province: 'Entre Ríos',      type: 'utn', color: '#C8102E', logo: '/logos/utn_par.svg'   },
  { id: 'utn_ave',   name: 'UTN-Avell.',    full: 'UTN Facultad Regional Avellaneda',          province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_ave.svg'   },
  { id: 'utn_hae',   name: 'UTN-Haedo',     full: 'UTN Facultad Regional Haedo',               province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_hae.svg'   },
  { id: 'utn_sn',    name: 'UTN-S.Nicolás', full: 'UTN Facultad Regional San Nicolás',         province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_sn.svg'    },
  { id: 'utn_fcu',   name: 'UTN-CdU',       full: 'UTN Facultad Regional Concepción del Urug.', province: 'Entre Ríos',    type: 'utn', color: '#C8102E', logo: '/logos/utn_fcu.svg'   },
  { id: 'utn_con',   name: 'UTN-Concordia', full: 'UTN Facultad Regional Concordia',           province: 'Entre Ríos',      type: 'utn', color: '#C8102E', logo: '/logos/utn_con.svg'   },
  { id: 'utn_del',   name: 'UTN-Delta',     full: 'UTN Facultad Regional Delta',               province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_del.svg'   },
  { id: 'utn_gp',    name: 'UTN-G.Pacheco', full: 'UTN Facultad Regional General Pacheco',     province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_gp.svg'    },
  { id: 'utn_lr',    name: 'UTN-La Rioja',  full: 'UTN Facultad Regional La Rioja',            province: 'La Rioja',        type: 'utn', color: '#C8102E', logo: '/logos/utn_lr.svg'    },
  { id: 'utn_nqn',   name: 'UTN-Neuquén',   full: 'UTN Facultad Regional Neuquén',             province: 'Neuquén',         type: 'utn', color: '#C8102E', logo: '/logos/utn_nqn.svg'   },
  { id: 'utn_raf',   name: 'UTN-Rafaela',   full: 'UTN Facultad Regional Rafaela',             province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_raf.svg'   },
  { id: 'utn_rec',   name: 'UTN-Reconq.',   full: 'UTN Facultad Regional Reconquista',         province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_rec.svg'   },
  { id: 'utn_sfc',   name: 'UTN-S.Fco.',    full: 'UTN Facultad Regional San Francisco',       province: 'Córdoba',         type: 'utn', color: '#C8102E', logo: '/logos/utn_sfc.svg'   },
  { id: 'utn_sr',    name: 'UTN-S.Rafael',  full: 'UTN Facultad Regional San Rafael',          province: 'Mendoza',         type: 'utn', color: '#C8102E', logo: '/logos/utn_sr.svg'    },
  { id: 'utn_sc',    name: 'UTN-S.Cruz',    full: 'UTN Facultad Regional Santa Cruz',          province: 'Santa Cruz',      type: 'utn', color: '#C8102E', logo: '/logos/utn_sc.svg'    },
  { id: 'utn_tdf',   name: 'UTN-TDF',       full: 'UTN Facultad Regional Tierra del Fuego',    province: 'Tierra del Fuego',type: 'utn', color: '#C8102E', logo: '/logos/utn_tdf.svg'   },
  { id: 'utn_tl',    name: 'UTN-Trenque',   full: 'UTN Facultad Regional Trenque Lauquen',     province: 'Buenos Aires',    type: 'utn', color: '#C8102E', logo: '/logos/utn_tl.svg'    },
  { id: 'utn_vt',    name: 'UTN-V.Tuerto',  full: 'UTN Facultad Regional Venado Tuerto',       province: 'Santa Fe',        type: 'utn', color: '#C8102E', logo: '/logos/utn_vt.svg'    },
  { id: 'utn_vm',    name: 'UTN-V.María',   full: 'UTN Facultad Regional Villa María',         province: 'Córdoba',         type: 'utn', color: '#C8102E', logo: '/logos/utn_vm.svg'    },
  { id: 'utn_chu',   name: 'UTN-Chubut',    full: 'UTN Facultad Regional Chubut',              province: 'Chubut',          type: 'utn', color: '#C8102E', logo: '/logos/utn_chu.svg'   },
